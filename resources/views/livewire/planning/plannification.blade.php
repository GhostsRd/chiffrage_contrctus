<div>
    {{-- <div class="container   ">
        <h3  id="titre-prof">Création Planning</h3>
        <p id="text-prof">Page  / Planification</p>   
    </div>   --}}
    <div class="col-lg-8 offset-lg-2 p-2">
        <ul id="top-tab-list" class="p-0 row list-inline">

            <li id="personnel" data-aos="fade-right" data-aos-delay="800"  class="mb-2 col-lg-2 col-md-6  shadow-sm rounded-5 past">
                <a href="{{url('/devis')}}"  class="nav-link">
                    <div class="iq-icon me-3  fw-bold">
                        <svg data-aos="fade-down" data-aos-delay="1900" class="svg-icon icon-20 rounded-4 text-primary fw-bold " xmlns="http://www.w3.org/2000/svg" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="shadow-sm p-4 container rounded-3 bg-white">
          
      {{-- <hr class="col-lg-5 offset-lg-3 col-5"> --}}
       
        <div class="  p-2 rounded-2 col-lg-4" style="border:#C6FF00 1px solid">
        ...
        <div class="row p-2 m-2 " style="font-size: 0.75rem">
            <div id="modal" class="col-lg-3  border-0 rounded-3 text-sm {{$planning_active}} shadow"  >
                <form wire:submit.prevent="planningData">
                        <h5 class="fw-bold text-info text-center">Planification</h5>
                        <hr>
                        <label for="" class="m-2 fw-bold ">Description :</label> <br>
                   
                        <input type="text" name="" wire:model="description" id="" placeholder="Déscription" 
                        class="form-control-sm border rounded-3 w-100  "><br>
                        <label for="" class="m-2 fw-bold " required>Date Début :</label><br>
                        <input type="date" name="" wire:model="date" id="" placeholder="Date debut du planning"
                         class="form-control-sm border w-100 rounded-3  shadow-sm ">
                         <hr>

                            <div class="row offset-lg-1">
                                <div class="col-lg-2 m-2 me-1">

                                    <button type="submit" class="btn btn-info text-white  btn-sm border-0 m-2  shadow-sm rounded-5   ">Ajouter</button>
                                </div>
                                <div class="col-lg-2 m-2 ms-4">

                                    <button  class="btn      text-info m-2  btn-sm border border-info shadow-sm rounded-5   "><a href="" class="nav-link">Annuler</a></button>
                                </div>

                            </div>
                    </form>       
            </div>
            {{-- <div class="col-lg-4 border rounded-3 p-
                <h5 class="">Paramétre de l'item</h5>
                <hr>
                <form wire:submit="planning">
                    <div class="row">
                        <div class="col-lg-3 m-2">
                            <label for="" class="fw-bold ">Item :</label>

                        </div>
                        <div class="col-lg-8    ">
                            <select name="" id="" wire:model="val" class="shadow-sm text-capitalize  form-control-sm border   rounded-3  text-muted " required>
                                <option value="">select item</option>
                              @foreach ($plans as $plan )
                              <option value="{{$plan->id}}">{{$plan->designation}}</option>
                              @endforeach
                  ...
                  <div class="row m-1">
                    <div class="col-lg-7 m-2 ">
                        ...
                        <label for="" class="fw-bold" > Debut du Jour:</label>
                    </div>
                    <div class="col-lg-4">
                       <input type="number" name="" id=""  wire:model="debut" class="form-control-sm  border w-100 rounded-3 shadow-sm"   placeholder="date debut">
                   </div>
                  </div>
                  <hr>
                   
                    <button type="submit" class="btn btn-outline-secondary btn-sm border-0 mt-2 shadow-sm rounded-5 offset-lg-9 ">Valider</button>
       
                    
                </form>
            </div> --}}
            <div class="col-lg-3 border rounded-3 ms-2 p-2 shadow {{$item_active}}" id="modal">
                <form wire:submit.prevent="changecouleur">
                <h5>Couleur de l'item</h5>
                <hr>
                <div class="row">
                    <div class="col-lg-4 m-2">
                        <label for="">Séction :</label>
                    </div>
                    <div class="col-lg-5">
                        <select name="" id="" wire:model="idsection" class="shadow-sm text-capitalize  form-control-sm border rounded-3  text-muted mb-2">
                            <option value="">select séction </option>
                            @foreach ($sections as $sect)
                                <option value="{{$sect->id}}">{{$sect->designation}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                   <div class="row">
                    ...
                    <div class="col-lg-5 ">
                        <select name="" id="" wire:model="couleur" class="shadow-sm text-capitalize  form-control-sm border  rounded-3  text-muted mb-2">
                            <option value="">select couleur</option>
                            <option value="bg-dark">Noire</option>
                   ...
                   <div class="row">
                    <div class="col-lg-2 offset-lg-4">
                        <button type="submit" class="btn btn-success btn-sm border-0  mt-2 rounded-5 shadow-sm">Changer</button>

                    </div>
                    <div class="col-lg-2 offset-1">

                        <button type="submit" class="btn btn-primary text-white m-2 btn-sm border-0  shadow-sm rounded-5   "><a href="" class="nav-link">Annuler</a></button>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-1 offset-lg-2 ">
                <select name="" id="" wire:model="choix_planning" wire:change="affichage" class="form-control-sm mt-2">
                    <option value="">choix planning</option>
                ...
                <div class="p-2 " >
                    <ul>
                        <li class="nav-item dropdown" style="list-style: none;font-size:0.7rem">
                            <a id="navbarDropdown" 
                            class="fw-bold dropdown-toggle  bg-none text-dark bg-white p-2  rounded-3 text-center  nav-link" 
                            href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre
                            style="border:#C6FF00 1px solid">
                                ...
                                <svg width="15" viewBox="0 0 24 24" class="animated-rotate icon-24" fill="none"
                                style="color:#C6FF00"
                           ...
                           <div class="dropdown-menu dropdown-menu-end bg-white text-center border-0 "
                           style="font-size:0.65rem"
                           aria-labelledby="navbarDropdown" style="cursor: pointer">
    
                                <span class="rounded-1 fw-bold  nav-link text-capitalize"  wire:click="form_planning" style="cursor: pointer">Planning</span>
                                {{-- <hr>
                                <span class="rounded-1 fw-bold  nav-link text-capitalize" wire:click="form_item" >Couleur d'Item</span>
         --}}
            ...
            @if ($item->choix_planning == "true")
                <table style="background: white;cursor: pointer;overflow:scrool" id="user-list-table" class="table text-sm  text-capitalize border rounded-1  display table-responsive "  data-bs-toggle="data-table">
                    ...
                    {{-- <tr>          
                        ...
                        {{-- esssai click click --}}
                        <tr>          
                            <th rowspan="" class="border fw-bold w-100" style="background:rgba(209, 221, 225, 0.097); font-size:0.6rem">{{$item->designation}} : {{$it->date_debut + 1}} au {{$it->date_debut + $it->duree }} Jour </th>
                
                    
                                @if ($it->date_debut > 0)
                                    <td class="border-0 bg-white"></td>
                                <td  colspan="{{ceil($it->date_debut /5)}}" class="border-0  bg-white "></td>
                                <td  title="{{$item->designation}}" colspan="{{ceil($it->duree / 5)}}" class="border-0 bg-white " style="font-size: 0.8rem;height:0.7px;padding-left:0;" wire:click="modal('{{$item->id}}','{{$item->designation}}')" >
                                    <div    data-aos="fade-right" data-aos-delay="600" class="  progress-bar text-center border-0 fw-bold text-white  rounded-end-4 shadow-sm  {{$sec->couleur}}" data-toggle="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 100%;height:100%; transition: width 2s ease 0s;">
                                        {{-- ceil() pour arrondir en plus grand --}}
                                ...
                                @else
                                <td  class="border-0 bg-white"></td>
                                <td title="{{$item->designation}}"  colspan="{{ceil($it->duree / 5)}}" class="border-0  bg-white " style="font-size: 0.8rem;padding-left:0;height:0.7px" wire:click="modal('{{$item->id}}','{{$item->designation}}')" >
                                    <div data-aos="fade-right" data-aos-delay="800" class=" pl-0 progress-bar text-center border-0 fw-bold text-white  rounded-end-4 shadow-sm   {{$sec->couleur}}" data-toggle="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" 
                                        style="width: 100%;height:100%; transition: width s ease 0s;">
                                        {{-- {{ceil($it->duree / 5)}} --}}
                                    </div>
                                </td>
                                @endif
      ...
      <hr class="offset-5 col-lg-6 col-1">
      <div >
  
          <a href="{{url('/chiffrage')}}" >
            <svg class="icon-32 text-primary offset-lg-9 offset-5" width="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                <path opacity="0.4" d="M12 22.0002C6.485 22.0002 2 17.5142 2 12.0002C2 6.48624 6.485 2.00024 12 2.00024C17.514 2.00024 22 6.48624 22 12.0002C22 17.5142 17.514 22.0002 12 22.0002Z" fill="currentColor"></path>                                <path d="M13.4425 16.2208C13.2515 16.2208 13.0595 16.1478 12.9135 16.0018L9.42652 12.5318C9.28552 12.3908 9.20652 12.1998 9.20652 11.9998C9.20652 11.8008 9.28552 11.6098 9.42652 11.4688L12.9135 7.99683C13.2065 7.70483 13.6805 7.70483 13.9735 7.99883C14.2655 8.29283 14.2645 8.76783 13.9715 9.05983L11.0185 11.9998L13.9715 14.9398C14.2645 15.2318 14.2655 15.7058 13.9735 15.9998C13.8275 16.1478 13.6345 16.2208 13.4425 16.2208Z" fill="currentColor"></path>                                </svg>                            
          </a>
              <a href="{{url("/facture")}}">
                  <svg class="icon-32 text-info" width="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" >       
                      <path opacity="0.4" d="M12 1.99976C17.515 1.99976 22 6.48576 22 11.9998C22 17.5138 17.515 21.9998 12 21.9998C6.486 21.9998 2 17.5138 2 11.9998C2 6.48576 6.486 1.99976 12 1.99976Z" fill="currentColor"></path>                                <path d="M10.5575 7.77917C10.7485 7.77917 10.9405 7.85217 11.0865 7.99817L14.5735 11.4682C14.7145 11.6092 14.7935 11.8002 14.7935 12.0002C14.7935 12.1992 14.7145 12.3902 14.5735 12.5312L11.0865 16.0032C10.7935 16.2952 10.3195 16.2952 10.0265 16.0012C9.73448 15.7072 9.73548 15.2322 10.0285 14.9402L12.9815 12.0002L10.0285 9.06017C9.73548 8.76817 9.73448 8.29417 10.0265 8.00017C10.1725 7.85217 10.3655 7.77917 10.5575 7.77917Z" fill="currentColor"></path>                                </svg>                           
              </a>
    ...
    {{-- <div id="modal" data-aos="zoom-in" data-aos-delay="600"  class="fade {{$form}} shadow border  bg-white " method="POST">
        <div class="   rounded-3 p-2">
            <h5 class="">Paramétre de l'item</h5>
            <hr>
            <form method="POST" action="{{url('planning/update')}}">
                @csrf
                <div class="row">
                    <div class="col-lg-3 m-2">
                        <label for="" class="fw-bold ">Item :</label>
                    ...
                    <div class="col-lg-8    ">
                        ...
                        <input type="text"  id="" class="form-control-sm border shadow-sm fw-bold " value="{{$design_item}}" disabled>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                   <input type="number"  name="debut"   class="form-control-sm  border w-100 rounded-3 shadow-sm"   placeholder="date debut">
               </div>
              </div>
              <hr>
  ...
  <div id="notification" class="rounded-3 p-2 active shadow  ">
    ...
    <svg class="icon-32 text-primary" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 11.9993C2 6.48027 6.48 1.99927 12 1.99927C17.53 1.99927 22 6.48027 22 11.9993C22 17.5203 17.53 21.9993 12 21.9993C6.48 21.9993 2 17.5203 2 11.9993ZM11.12 8.20927C11.12 7.73027 11.52 7.32927 12 7.32927C12.48 7.32927 12.87 7.73027 12.87 8.20927V12.6293C12.87 13.1103 12.48 13.4993 12 13.4993C11.52 13.4993 11.12 13.1103 11.12 12.6293V8.20927ZM12.01 16.6803C11.52 16.6803 11.13 16.2803 11.13 15.8003C11.13 15.3203 11.52 14.9303 12 14.9303C12.49 14.9303 12.88 15.3203 12.88 15.8003C12.88 16.2803 12.49 16.6803 12.01 16.6803Z" fill="currentColor"></path>                            </svg>                        
        {{-- <svg class="icon-32 text-success" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.67 2H16.34C19.73 2 22 4.38 22 7.92V16.091C22 19.62 19.73 22 16.34 22H7.67C4.28 22 2 19.62 2 16.091V7.92C2 4.38 4.28 2 7.67 2ZM11.43 14.99L16.18 10.24C16.52 9.9 16.52 9.35 16.18 9C15.84 8.66 15.28 8.66 14.94 9L10.81 13.13L9.06 11.38C8.72 11.04 8.16 11.04 7.82 11.38C7.48 11.72 7.48 12.27 7.82 12.62L10.2 14.99C10.37 15.16 10.59 15.24 10.81 15.24C11.04 15.24 11.26 15.16 11.43 14.99Z" fill="currentColor"></path>                            </svg>                         --}}
        <a href="" class="nav-link ms-1">
            <span class="fw-bold text-capitalize">Info</span><br>
           {{-- RAKTOnirina rado leonce RAKTOnirina LEONCERARAKOROIN --}}
