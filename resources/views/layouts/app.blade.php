        ...
        <nav class="navbar navbar-expand-md navbar-secondary  text-white  shadow-none p-1 " style="background: rgba(255, 255, 255, 0.898);">
            <div class="container">
                ...
                <div  class="collapse navbar-collapse text-white p-2" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown">
                        <a id="titre-prof" class="fw-bold dropdown-toggle hover nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            ...
                            <div class="dropdown-menu dropdown-menu-end bg-white border-0 shadow-sm " aria-labelledby="navbarDropdown" style="font-size: 0.7rem;  z-index:5">
                                ...
                                <a class="nav-link  text-center hover" id="titre-prof" href="{{url('/employer')}}"
                               >
                    ...
                    <li class="nav-items">
                        <a id="titre-prof" href="{{route('facture')}}" class="nav-link fw-bold ">
